...
echo color("red","| Auto register & Auto Redeem |\n");
echo color("red","| github   : RyzentDz-Code    |\n");
echo color("red","| Creator  : goyigoylucu      |\n");
echo color("red","| Token by : GarutIndie       |\n");
echo color("red"," =============================\n");
...
// function change(){
        ...
        $data = '{"email":"'.$email.'@goyigoylucu.com","name":"'.$nama.'","phone":"+'.$hp.'","signed_up_country":"ID"}';
